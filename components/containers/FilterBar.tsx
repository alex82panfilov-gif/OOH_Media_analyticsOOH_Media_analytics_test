        ...
        <div className={`mt-4 md:mt-0 ${isOpen ? 'block' : 'hidden'} md:block`}>
          <div className="flex flex-wrap gap-4 items-end">
            ...
            <div className="ml-auto flex gap-2">
              {userRole === 'ADMIN' && <button onClick={handleExport} disabled={isExporting} className="px-6 py-2 bg-teal-600 text-white rounded-lg text-xs font-bold uppercase hover:bg-teal-700 transition-colors disabled:opacity-60">{isExporting ? 'Экспорт...' : 'Excel'}</button>}
